  ...
  return (
    <main className=" min-h-svh bg-offwhitebg py-20 px-6">
      <section>
        ...
        <p className="font-lexend mb-7">Texto texto texto pipipipopopo de não sei oque não sei oque lá, de pontinho vermelho aqui de pontinho vermleho cá, que fulano falou pra cicrano que não sei oque de pipipipopopo</p>
        ...
        <div className="bg-green p-12">
          ...
          <p className="font-lexend mb-7"> texto de cá texto de lá</p>
        ...
        <div className="bg-dark-green p-12 rounded-b-lg">
          ...
          <p className="font-lexend mb-7">carrinhos de luxo vrum vrum</p>
